...
/** if you want to use rng you can use the following instructions.
 *
 * STEP 1, open rng driver framework support in the RT-Thread Settings file
 *
 * STEP 2, define macro related to the rng
 *                 such as     #define BSP_USING_RNG
 *
 * STEP 3, copy your rng init function from stm32xxxx_hal_msp.c generated by stm32cubemx to the end of board.c file
 *                 such as     void HAL_RNG_MspInit(RNG_HandleTypeDef* hrng)
 *
 * STEP 4, modify your stm32xxxx_hal_config.h file to support rng peripherals. define macro related to the peripherals
 *                 such as     #define HAL_RNG_MODULE_ENABLED
 *
 */
